...
var _focusLock = require("./modules/autofocus/focus-lock");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    var btn = document.querySelector('[data-show="button"]');

    //записываем DOM элемент в переменную*
    var parent = document.querySelector('[data-show="parent"]');
...
},{"./modules/accordions/init-accordion":3,"./modules/autofocus/focus-lock":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/phone-mask/phone-mask":14,"./modules/textarea/auto-resize-textarea":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
